...
<header class="modern-navbar">
    <div class="nav-container">
        ...
        <a href="{{ url('/') }}" class="nav-brand">
            ...
            <span>Seabank<span style="color: #374151;">Pay</span></span>
        </a>

        <!-- Desktop Navigation -->
        <nav class="nav-links" id="navLinks">
            <a href="{{ url('/dashboard') }}" class="nav-item {{ request()->is('dashboard') ? 'active' : '' }}">Dashboard</a>
        ...
        <div class="nav-right">
            ...
            <div class="user-menu">
                <div class="user-trigger">
                    ...
                    <div class="user-info">
                        <span class="user-name">{{ Auth::user()->full_name ?? 'Guest' }}</span>
                ...
                <div class="dropdown-menu">
                    ...
                    <form method="POST" action="{{ route('logout') }}" id="logout-id">
                        @csrf
                        <a href="#" onclick="document.getElementById('logout-id').submit();" class="dropdown-item" style="color: #ef4444;">
